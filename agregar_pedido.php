      ...
      <div class="modal-body">
        ...
        <form>
          ...
          <div class="mb-3">
            ...
            <p class="mx-1" style="font-size: 10px; color: red;"><b>*Se llamará a este numero cuando el pedido este listo*</b></p>
          </div>
          ...
          <div style="display: flex; flex-wrap: wrap; display: flex;justify-content: space-between; align-items: flex-start; padding: 0px 20px;">
            <div>
              <div style="text-align: center;">
                ...
                <div>
                  <label style="width: 70px;">piña</label>
                  <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked>
                </div>
            </div>
            <div>
